...
const Chapter1 = () => {
  return <div className="space-y-8">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-xl text-blue-900">1.1. ¿Qué implica ser persona cuidadora?</h2>
        ...
        <h2 className="text-xl text-blue-900">1.2. ¿Qué puede hacer para cuidarse?</h2>
        <ul>
        ...
        <h2 className="text-xl text-blue-900">1.3. Duelo</h2>
        <p>
