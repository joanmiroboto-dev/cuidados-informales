...
const Chapter2 = () => {
  return <div className="space-y-8">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-xl text-blue-900 font-bold">2.1. Ciclo de la vida y sus etapas</h2>
        ...
        <p>La vejez no aparece de manera brusca, sino que forma parte de un proceso continuo: el envejecimiento.

      </p>

        <h2 className="text-xl text-blue-900 font-bold">2.2. Envejecimiento y sus características</h2>
        ...
        <ul>
          ...
          <li>Cambios en la funcionalidad de órganos y sistemas

        </li>
        </ul>

        <h2 className="text-xl text-blue-900 font-bold">2.3. Cambios fisiológicos asociados al envejecimiento</h2>
        ...
        <ul>
          ...
          <li>Opacidad progresiva del cristalino

        </li>
        </ul>

        <h3 className="text-lg font-bold">Audición</h3>
        <ul>
          <li>Hipoacusia</li>
        ...
        <ul>
          ...
          <li>Aparición de arrugas, manchas, sequedad y flacidez

        </li>
        </ul>

        <h3 className="text-lg font-bold">Olfato y gusto</h3>
        <ul>
        ...
        <ul>
          ...
          <li>Reducción de masa y fuerza muscular

        </li>
        </ul>

        <h3 className="text-lg font-bold">Sistema cardiovascular</h3>
        <ul>
          <li>Estrechamiento y menor elasticidad de los vasos sanguíneos</li>
          <li>Mayor presión sobre el ventrículo izquierdo</li>
          <li>Disminución de la capacidad de contracción

        </li>
        </ul>

        <h3 className="font-bold">Sistema respiratorio</h3>
        <ul>
          <li>Capacidad vital disminuida</li>
          <li>Mayor volumen residual</li>
          <li>Debilitamiento de la musculatura respiratoria</li>
          <li>Reducción de la función mucociliar

        </li>
        </ul>

        <h3 className="text-lg font-bold">Sistema excretor y reproductor</h3>
        <ul>
          ...
          <li>Reducción progresiva de la función renal
        ...
        <ul>
          ...
          <li>Pérdidas dentales y menor producción de ácido clorhídrico

        </li>
        </ul>

        <h3 className="text-lg font-sans font-bold">Rol social</h3>
